...
def __find1DBisectionAscending__(lookup, target):
    left = int(0)
    right = int(len(lookup.__axis__) - 1)
...
def __find1DBisectionDescending__(lookup, target):
    left = int(0)
    right = int(len(lookup.__axis__) - 1)
